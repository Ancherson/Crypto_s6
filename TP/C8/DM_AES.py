...
def hash_merkle_damguard(text):
    ...
    nb_blocks = len(text) # text length is based on ASCII length which is 8 bits a char, but here we pas on 16-bits chars. Hopefully we declared an utf-16 encoding on line 1.
